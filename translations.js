...
const texts = {
  es: {
    ...
    heroTitle:"Cada vida es un <em>grafo</em>: nodos que fuimos, aristas que nos hicieron.",
  ...
  en: {
    ...
    heroTitle:"Every life is a <em>graph</em>: nodes we were, edges that made us.",
  ...
  zh: {
    ...
    heroTitle:"每一生都是图：我们曾是<em>节点</em>，连线塑造了我们。",
